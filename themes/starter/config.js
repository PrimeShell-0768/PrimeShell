...
const CONFIG = {
  ...
  STARTER_HERO_BUTTON_2_TEXT: 'Get Quotation', // 英雄区按钮
  STARTER_HERO_BUTTON_2_URL: 'https://linktr.ee/Chen.Tony', // 英雄区按钮
  STARTER_HERO_BUTTON_2_ICON: '', // 英雄区按钮2的图标，不需要则留空

  STARTER_HERO_PREVIEW_IMAGE: '/images/starter/hero/hero-image.webp', // 产品预览图 ，默认读取public目录下图片

  // 顶部右侧导航暗流
  STARTER_NAV_BUTTON_1_TEXT: 'Contact',
  STARTER_NAV_BUTTON_1_URL: 'https://linktr.ee/Chen.Tony',

  STARTER_NAV_BUTTON_2_TEXT: 'Quotation',
  STARTER_NAV_BUTTON_2_URL: 'https://linktr.ee/Chen.Tony',
  ...
  // 嵌入外部表单
  STARTER_CONTACT_MSG_EXTERNAL_URL: 'https://noteforms.com/forms/prime-shell-coltd-ty5zal', // 基于NoteForm创建，将留言数据存在Notion中
  //   自定义留言表单，以下几个配置暂时废弃
